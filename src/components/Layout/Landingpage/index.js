  ...
  return (
    <div className='landing-container'>
      <div className='backdrop'>
        <h1>Live your <strong style={{color: 'Green'}}>Adventure</strong></h1>
        <p>Don't wait until tomorrow,  discover your 
        adventure now and feel the sensation <br /> 
            ...
            <div key={index} className='card'>
              ...
              <div className='card-content'>
                ...
                <div className='text-row'>
                  <h5>{r.location}</h5>
                  <LocationOnIcon style={{ fontSize: '18px', color: 'rgba(0, 0, 0, 0.2)', marginLeft: '0.5rem' }} />
                </div>
